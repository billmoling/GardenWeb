<%@ Page Language="C#" AutoEventWireup="true" Inherits="New" MasterPageFile="HomePage.master" Codebehind="New.aspx.cs" %>
        ...
        <div class="top-main">
            ...
            <div class="link-main">
                ...
                <asp:SqlDataSource ID="isNew" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM [productinfo] WHERE (([isNew] = @isNew) AND ([isPrivate] = @isPrivate))">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="true" Name="isNew" Type="Boolean" />
